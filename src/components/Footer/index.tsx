...
const Footer = () => {
  return (
    <>
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                At TechStrota, we&apos;re  the creators of digital solutions that shape the future. With code as our canvas and innovation as our brush, we craft tech-driven marvels that drive businesses forward. Join us in sculpting tomorrow&apos;s digital landscape.
                </p>
      ...
      <a
        href="https://www.instagram.com/techstrota/?igsh=MXJnMWZrY2xiNXprZQ%3D%3D"
        target="_blank"
        rel="noopener noreferrer"
        className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
